...
module.exports = container => {
  ...
  const Group = require('./group.model')(joi, mongoose, { joi2MongoSchema })
  const UserGroup = require('./userGroup.model')(joi, mongoose, { joi2MongoSchema })
  const Mod = require('./mod.model')(joi, mongoose, { joi2MongoSchema })
  const schemas = { Group, UserGroup, Mod }
